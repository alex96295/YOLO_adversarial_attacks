...
patchfile = "./patches/yv4/ale_obj_yolov4.jpg" 

square_size = 608 # can be whatever, because I remove the pad
patch_size = 300
...
for imgfile in os.listdir(imgdir):
    ...
    txt_clean_path = os.path.join('./single_box_trial_yolov4/yolov4_clean_fewdata_labels/', txt_clean_name)
    
    # create folders if they do not exists
    single_img_labdir = os.path.join('./single_box_trial_yolov4/yolov4_patched_fewdata_labels/', name, 'patch/')
    ...
    single_img_labdir_c = os.path.join('./single_box_trial_yolov4/yolov4_patched_fewdata_labels/', name, 'clean/')
    ...
    for single_box_label, single_box_label_nopad in zip(lab_fake_batch_boxsplit, lab_fake_batch_boxsplit_nopad):
        ...
        out_path_part = "./single_box_trial_yolov4/patch_applied_images_no_det/"
        ...
        out_path_part_detection = "./single_box_trial_yolov4/patch_applied_images_det/"
