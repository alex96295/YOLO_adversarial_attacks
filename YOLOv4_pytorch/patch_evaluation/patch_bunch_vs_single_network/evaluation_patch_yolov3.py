...
patch_yolov2_best = bb.io.load('det_coco', './json_files/yolov2_patches/patch_results_obj.json', class_label_map={0: 'person'})
patch_yolov3_best = bb.io.load('det_coco', './json_files/yolov3_patches/patch_results_obj.json', class_label_map={0: 'person'})
patch_yolov4_best = bb.io.load('det_coco', './json_files/yolov4_patches/patch_results_obj.json', class_label_map={0: 'person'})

patch_ssd_mbntv1 = bb.io.load('det_coco', './json_files/ssd_mbntv1_patches/patch_results_obj_cls.json', class_label_map={0: 'person'})
patch_ssdlite_mbntv2 = bb.io.load('det_coco', './json_files/ssdlite_mbntv2_patches/patch_results_obj_cls.json', class_label_map={0: 'person'})
patch_ensemble_yv2_ssd_mbntv1_ssdlitembntv2_best = bb.io.load('det_coco', './json_files/ensemble_yv2_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls.json', class_label_map={0: 'person'})
patch_ensemble_yv3_ssd_mbntv1_ssdlitembntv2_best = bb.io.load('det_coco', './json_files/ensemble_yv3_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls.json', class_label_map={0: 'person'})
patch_ensemble_yv2_yv3_ssdlitembntv2_best = bb.io.load('det_coco', './json_files/ensemble_yv2_yv3_ssdlitembntv2_patches/patch_results_obj_cls.json', class_label_map={0: 'person'})
