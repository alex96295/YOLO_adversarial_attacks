...
patch_results_obj = bb.io.load('det_coco', './json_files/yolov4_patches/patch_results_obj.json', class_label_map={0: 'person'})
#patch_results_cls = bb.io.load('det_coco', './json_files/yolov3_patches/patch_cls_results.json', class_label_map={0: 'person'})
patch_results_cls_obj = bb.io.load('det_coco', './json_files/yolov4_patches/patch_results_obj_cls.json', class_label_map={0: 'person'})
...
plt.gcf().suptitle('YOLOv4, ref. = inria_ground_truth, dataset:INRIA')
