...
if __name__ == '__main__':
    ...
    class PatchTrainer(object):
        ...
        def __init__(self, mode):
            ...
            self.darknet_model_yolov4 = Darknet(self.config.cfgfile_yolov4)
        ...
        def train(self):
            ...
            destination_path = "./"
            destination_name = 'loss_tracking_cw.txt'
            destination_name2 = 'loss_tracking_compact_batch_cw.txt'
            destination_name3 = 'loss_tracking_compatc_epochs_cw.txt'
            ...
            # NOTE MORITZ: Learning rate scheduling
            # Can be useful to use SGD -> change LR / Momentum by hand
            ...
            for epoch in range(n_epochs):
                ...
                for i_batch, (img_batch, lab_batch) in tqdm(enumerate(train_loader), desc=f'Running epoch {epoch}',
                    ...
                    with autograd.detect_anomaly():
                        ...
                        #p_img_show = transforms.ToPILImage('RGB')(p_img_batch[0])
                        #p_img_show.save('C:/Users/Alessandro/Desktop/img.png')

                        print('Fino a qui tutto bene')

                        loss_type = "carlini_wagner"

                        output = self.darknet_model_yolov4(p_img_batch)  

                        score_yolov4 = self.score_extractor_yolo(output, loss_type) # output is done by the three last layers as yv3
                        ...
                        # NOTE MORITZ: log det_loss, tv_loss, np_loss
                        # Always make sure det_loss >= alpha * (tv_loss+nps_loss)
                        # If not => tv_loss+nps_loss * 0.1
                        if use_cuda:
                ...
                if True:
                    ...
                    # plt.imshow(im)
                    # plt.show()
                    im.save("/scratch/msc20f3/master_thesis/saved_patches_mytrial/yolov4_cw.jpg")
